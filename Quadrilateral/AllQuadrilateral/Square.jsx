...
const Square = () => {
    ...
    useEffect(() => {
        if (!isActiveButton.isAngle && !isActiveButton.isCSide && !isActiveButton.isSide && !isActiveButton.isInfo) {
            setData("");
        }
    }, [isActiveButton]);
    ...
    return (
        <div style={{
            ...
            <Quadrilateral label="Square" points="50,50 250,50 250,250 50,250"
