...
const Quadrilateral = ({ label, points, isActiveButton }) => {
    ...
    const drawSideArrows = (start, end, count = 1, direction = "left", spacingFactor = 0.3) => {
        const arrows = [];
        const step = 1 / (count + 1 || 1); // base step if count > 1
        const offset = (1 - spacingFactor) / 1.5; // to center compressed arrows
...
const Isoscelesrapezoid = () => {
    ...
    useEffect(() => {
        if (!isActiveButton.isParAngle && !isActiveButton.isConAngle && !isActiveButton.isConSide && !isActiveButton.isInfo) {
            setData("");
        }
    }, [isActiveButton]);
    return (
        <div style={{
            ...
            <Quadrilateral
                label="Isosceles Trapezoid"
                points="80,50 220,50 250,250 50,250"
            ...
            <div style={{ display: "flex", bottom: "20px", alignItems: "center", justifyContent: "center", flexWrap: "wrap", gap: "20px", width: "full", height: "100px", borderRadius: "20px" }}>
                <div style={{ display: "flex", alignItems: "center", justifyContent: "space-evenly", width: "full", gap: "20px" }}>
                    ...
                    <CommonButton value="Mark Congruent Angles"
                        ...
                        onClick={() => {
                            playClickSound()
                            setData(`Base angles are equal to each other.`)
                            setIsActiveButton((prev) => ({
                                // ...prev,
                    ...
                    <CommonButton value="Mark Congruent Sides"
                        ...
                        onClick={() => {
                            playClickSound()
                            setData(`One pair of the opposite sides are equal.`)
                            setIsActiveButton((prev) => ({
                                // ...prev,
                    ...
                    <CommonButton value="Show Info"
                        ...
                        onClick={() => {
                            playClickSound()
                            setData(`
                                 ● One pair of the opposite sides are equal.<br/>
...
export default Isoscelesrapezoid