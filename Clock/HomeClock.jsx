...
const HomeClock = ({ handleDataTrack = () => { }, prop }) => {
    ...
    return (
        <div className=" bg-pink-200 h-[100%] flex flex-col items-center justify-center overflow-hidden relative" id="enable-full-screen">

            {!isLiveClass && <div className="absolute top-5 right-5">
                <img src="https://d3g74fig38xwgn.cloudfront.net/teaching-tool/full.png" alt="full-screen" onClick={toggleFullscreen} />

            </div>}
            <div
                className={`w-full max-w-md h-full flex flex-col items-center justify-between px-4 py-4 bg-pink-200   ${isLiveClass? "":"gap-5"} `}
